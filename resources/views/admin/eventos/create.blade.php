...
<div class="container">
    <div class="row">
        <div class="col-md-5 text-muted">
            Preencha os dados do formulário ao lado para cadastrar um novo item na categoria <strong>Eventos</strong>.
        </div>
        <div class="col-md-7">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admevents.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
